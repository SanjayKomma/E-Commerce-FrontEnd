...
const ManageProductsPage = () => {
  ...
  // Check if current user has permissions for a specific product
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-6">
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-3xl border border-gray-200 p-12 text-center text-xs text-gray-500">
          No products found in the catalog. Click "Add New Product" to start.
        </div>
      ) : (
                        ...
                        {allowed ? (
                          <>
                            <button
                              ...
                              className="px-3 py-1.5 font-semibold text-indigo-600 bg-indigo-50 hover:bg-indigo-100 rounded-lg transition"
                            >
                              Edit
                            </button>
                            <button
                              onClick={() => handleDelete(product._id)}
                              className="px-3 py-1.5 font-semibold text-red-600 bg-red-50 hover:bg-red-100 rounded-lg transition"
                            >
                              Delete
                            </button>
                          </>
